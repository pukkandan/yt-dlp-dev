...
from .utils import Popen, traverse_obj
...
def run_update(ydl):
    ...
    new_filename = f'{filename}.new' if variant in ('win_exe', 'py2exe') else filename
    ...
    try:
        ...
        Popen(f'ping 127.0.0.1 -n 5 -w 1000 & del /F "{filename}.old"',
