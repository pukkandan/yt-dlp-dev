...
class EnhancedModule(types.ModuleType):
    def __new__(cls, name, *args, **kwargs):
        assert name != __name__, 'Cannot create EnhancedModule for this module'
...
def passthrough_module(parent, child, allowed_attributes=None, *, callback=lambda _: None):
    """Passthrough parent module into a child module. If parent=None, then a new module is created"""
